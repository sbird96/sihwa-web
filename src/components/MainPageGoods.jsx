         ...
         <div className="goods">
            <div className="container">
               <OwlCarousel className="owl-theme goods-carousel" {...OwlOptions}>
                  {
                     goodsData && goodsData.map((goodsdata) => (
                        <div className="goods-item" key={goodsdata.GoodsID}>
                           <div className="goods-img">
                              <img src={"images/Goods/" + goodsdata.GoodsImage} alt={goodsdata.GoodsTitle} />
                           </div>
                           <p dangerouslySetInnerHTML={{ __html: goodsdata.GoodsContent }}></p>
